...
control "bigip-declarative-onboarding" do
  impact 1.0
  title "BIGIP has Declarative Onboarding"
...
control "bigip-declarative-onboarding-version" do
  impact 1.0
  title "BIGIP has specified version of Declarative Onboarding"
...
control "bigip-application-services" do
  impact 1.0
  title "BIGIP has Application Services"
  # is the declarative onboarding end point available?
...
control "bigip-application-services-version" do
  impact 1.0
  title "BIGIP has specified version of Application Services"
